                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <strong>Ajouter un Work</strong>
                        </div>
                        <form action="{{ route('addWorks') }}" method="POST">
                            {{ csrf_field() }}
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                            ...
                            <table class="table table-responsive-sm table-bordered table-striped table-sm">
                                ...
                                <tbody>
                                    @foreach($data as $work)
                                        <tr>
                                            <td>
                                                <a href="/admin/works/edit/{{ $work->id }}">
                                                    {{$work->title}}
                                                </a>
                                            </td>
                                            <td><img style="width: 100px; height: auto;" src="{{ asset($work->cover) }}" alt=""></td>
